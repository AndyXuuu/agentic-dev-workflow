...
export const resourceConfig: Record<ResourceKey, { title: string; description: string; primaryAction: string; search: string }> = {
  orders: {
    title: '订单管理',
    description: '查询履约状态、支付结果与客户信息。',
    primaryAction: '创建订单',
    search: '搜索订单或客户',
  },
  products: {
    title: '商品管理',
    description: '维护商品目录、价格和库存状态。',
    primaryAction: '添加商品',
    search: '搜索商品或分类',
  },
  customers: {
    title: '客户管理',
    description: '查看客户状态、消费贡献和最近活动。',
    primaryAction: '添加客户',
    search: '搜索客户或邮箱',
  },
}

export const resourceRows: Record<ResourceKey, readonly ResourceRow[]> = {
  orders: [
    {
      id: 'ORD-9952',
      title: 'Sarah Jenkins',
      subtitle: 'sarah@example.com',
      meta: '2026-08-04 · Visa',
      value: '¥1,290',
      status: '已完成',
      tone: 'success',
    },
